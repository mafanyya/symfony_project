...
class Item extends \App\Entity\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'price', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'img', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'categories', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'age', '' . "\0" . 'App\\Entity\\Item' . "\0" . 'comments'];
        }
